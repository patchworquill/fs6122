// fs6122 pressure, flow sensor library i2c
// by Patrick Wilkie <http://github.com/patchworquill>

// Reads data from an fs6122 medical sensor
// such as pressure, flow, temperature and RH
// Readings via the I2C bus protocol
